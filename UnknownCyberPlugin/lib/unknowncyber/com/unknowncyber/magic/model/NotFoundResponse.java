...
public class NotFoundResponse implements Serializable{
  ...
  public NotFoundResponse success(Boolean success) {
  ...
  **/
  ...
  public NotFoundResponse status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public NotFoundResponse errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public NotFoundResponse addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public NotFoundResponse links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public NotFoundResponse putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.success, notFoundResponse.success) &&
        Objects.equals(this.status, notFoundResponse.status) &&
        Objects.equals(this.message, notFoundResponse.message) &&
        Objects.equals(this.errors, notFoundResponse.errors) &&
        Objects.equals(this.links, notFoundResponse.links);
  }
