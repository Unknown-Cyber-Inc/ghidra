...
import com.unknowncyber.magic.model.FileChild;
...
public class EnvelopedFileChildList200 implements Serializable, EnvelopedFileList200EnvelopedFileChildList200 {
  ...
  private List<FileChild> resources = new ArrayList<FileChild>();

  public EnvelopedFileChildList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedFileChildList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedFileChildList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedFileChildList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedFileChildList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedFileChildList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedFileChildList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedFileChildList200 resources(List<FileChild> resources) {
    this.resources = resources;
    return this;
  }

  public EnvelopedFileChildList200 addResourcesItem(FileChild resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<FileChild> getResources() {
    return resources;
  }

  public void setResources(List<FileChild> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedFileChildList200 envelopedFileChildList200 = (EnvelopedFileChildList200) o;
    return Objects.equals(this.success, envelopedFileChildList200.success) &&
        Objects.equals(this.status, envelopedFileChildList200.status) &&
        Objects.equals(this.message, envelopedFileChildList200.message) &&
        Objects.equals(this.errors, envelopedFileChildList200.errors) &&
        Objects.equals(this.links, envelopedFileChildList200.links) &&
        Objects.equals(this.resources, envelopedFileChildList200.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedFileChildList200 {\n");
