...
import com.unknowncyber.magic.model.LabelSchema;
...
public class FileLabels implements Serializable{
  private static final long serialVersionUID = 1L;
  @JsonProperty("ground_truth")
  private List<LabelSchema> groundTruth = null;

  @JsonProperty("inferred")
  private List<LabelSchema> inferred = null;
  ...
  **/
  @Schema(description = "")
  public List<LabelSchema> getGroundTruth() {
    return groundTruth;
  }
  ...
  **/
  @Schema(description = "")
  public List<LabelSchema> getInferred() {
    return inferred;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.groundTruth, fileLabels.groundTruth) &&
        Objects.equals(this.inferred, fileLabels.inferred);
  }

  @Override
  public int hashCode() {
    return Objects.hash(groundTruth, inferred);
  }
