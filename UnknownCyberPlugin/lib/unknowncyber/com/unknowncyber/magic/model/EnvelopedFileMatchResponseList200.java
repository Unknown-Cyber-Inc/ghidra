...
public class EnvelopedFileMatchResponseList200 implements Serializable, EnvelopedFileMatchResponseList200EnvelopedIdList200 {
  ...
  public EnvelopedFileMatchResponseList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedFileMatchResponseList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedFileMatchResponseList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedFileMatchResponseList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedFileMatchResponseList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedFileMatchResponseList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedFileMatchResponseList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedFileMatchResponseList200 addResourcesItem(FileMatchResponse resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<FileMatchResponse> getResources() {
    return resources;
  }

  public void setResources(List<FileMatchResponse> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedFileMatchResponseList200 envelopedFileMatchResponseList200 = (EnvelopedFileMatchResponseList200) o;
    return Objects.equals(this.success, envelopedFileMatchResponseList200.success) &&
        Objects.equals(this.status, envelopedFileMatchResponseList200.status) &&
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedFileMatchResponseList200 {\n");
