...
public class YaraRequest implements Serializable{
  ...
  private Integer maxSignatures = 16;

  public YaraRequest files(List<String> files) {
    this.files = files;
    return this;
  }

  public YaraRequest addFilesItem(String filesItem) {
  ...
  **/
  ...
  public YaraRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public YaraRequest unpacked(Boolean unpacked) {
  ...
  **/
  ...
  public YaraRequest config(String config) {
    this.config = config;
    return this;
  }
  ...
  **/
  ...
  public YaraRequest includeAll(Boolean includeAll) {
  ...
  **/
  ...
  public YaraRequest maxSignatures(Integer maxSignatures) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    YaraRequest yaraRequest = (YaraRequest) o;
    return Objects.equals(this.files, yaraRequest.files) &&
        Objects.equals(this.name, yaraRequest.name) &&
        Objects.equals(this.unpacked, yaraRequest.unpacked) &&
        Objects.equals(this.config, yaraRequest.config) &&
        Objects.equals(this.includeAll, yaraRequest.includeAll) &&
        Objects.equals(this.maxSignatures, yaraRequest.maxSignatures);
  }

  @Override
  public int hashCode() {
    return Objects.hash(files, name, unpacked, config, includeAll, maxSignatures);
  }
