...
import com.unknowncyber.magic.model.FileUpdateResponse;
...
public class EnvelopedFileUpdateResponse206 implements Serializable{
  private static final long serialVersionUID = 1L;
  @JsonProperty("success")
  private Boolean success = true;

  @JsonProperty("status")
  private Integer status = 206;

  @JsonProperty("message")
  private String message = "Resource Updated";
  ...
  private FileUpdateResponse resource = null;

  public EnvelopedFileUpdateResponse206 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedFileUpdateResponse206 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedFileUpdateResponse206 message(String message) {
  ...
  **/
  ...
  public EnvelopedFileUpdateResponse206 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedFileUpdateResponse206 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedFileUpdateResponse206 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedFileUpdateResponse206 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedFileUpdateResponse206 resource(FileUpdateResponse resource) {
  ...
  **/
  @Schema(required = true, description = "")
  public FileUpdateResponse getResource() {
    return resource;
  }

  public void setResource(FileUpdateResponse resource) {
    this.resource = resource;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedFileUpdateResponse206 envelopedFileUpdateResponse206 = (EnvelopedFileUpdateResponse206) o;
    return Objects.equals(this.success, envelopedFileUpdateResponse206.success) &&
        Objects.equals(this.status, envelopedFileUpdateResponse206.status) &&
        Objects.equals(this.message, envelopedFileUpdateResponse206.message) &&
        Objects.equals(this.errors, envelopedFileUpdateResponse206.errors) &&
        Objects.equals(this.links, envelopedFileUpdateResponse206.links) &&
        Objects.equals(this.resource, envelopedFileUpdateResponse206.resource);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedFileUpdateResponse206 {\n");
