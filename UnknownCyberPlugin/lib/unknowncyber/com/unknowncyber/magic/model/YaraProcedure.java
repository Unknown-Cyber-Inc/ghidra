...
public class YaraProcedure implements Serializable{
  private static final long serialVersionUID = 1L;
  @JsonProperty("proc_hashes")
  private List<String> procHashes = new ArrayList<String>();
  ...
  @JsonProperty("magic_yara_id")
  private String magicYaraId = null;

  @JsonProperty("magic_criteria_id")
  private String magicCriteriaId = null;

  public YaraProcedure procHashes(List<String> procHashes) {
    this.procHashes = procHashes;
    return this;
  }

  public YaraProcedure addProcHashesItem(String procHashesItem) {
    this.procHashes.add(procHashesItem);
    return this;
  }
  ...
  **/
  ...
  public List<String> getProcHashes() {
    return procHashes;
  }

  public void setProcHashes(List<String> procHashes) {
    this.procHashes = procHashes;
  }

  public YaraProcedure name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public String getMagicYaraId() {
    return magicYaraId;
  }

   /**
   * Get magicCriteriaId
   * @return magicCriteriaId
  **/
  @Schema(description = "")
  public String getMagicCriteriaId() {
    return magicCriteriaId;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    YaraProcedure yaraProcedure = (YaraProcedure) o;
    return Objects.equals(this.procHashes, yaraProcedure.procHashes) &&
        Objects.equals(this.name, yaraProcedure.name) &&
        Objects.equals(this.rule, yaraProcedure.rule) &&
        Objects.equals(this.magicYaraId, yaraProcedure.magicYaraId) &&
        Objects.equals(this.magicCriteriaId, yaraProcedure.magicCriteriaId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(procHashes, name, rule, magicYaraId, magicCriteriaId);
  }
  ...
  public String toString() {
    ...
    sb.append("class YaraProcedure {\n");
    
    sb.append("    procHashes: ").append(toIndentedString(procHashes)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    rule: ").append(toIndentedString(rule)).append("\n");
    sb.append("    magicYaraId: ").append(toIndentedString(magicYaraId)).append("\n");
    sb.append("    magicCriteriaId: ").append(toIndentedString(magicCriteriaId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
