...
import com.unknowncyber.magic.model.TaggedItem;
...
public class Tag implements Serializable{
  ...
  @JsonProperty("items")
  private List<TaggedItem> items = null;
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, tag.id) &&
        ...
        Objects.equals(this.files, tag.files) &&
        Objects.equals(this.fileCount, tag.fileCount) &&
        Objects.equals(this.items, tag.items) &&
        Objects.equals(this.color, tag.color) &&
        Objects.equals(this.username, tag.username) &&
        Objects.equals(this.comments, tag.comments) &&
        Objects.equals(this.createTime, tag.createTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, files, fileCount, items, color, username, comments, createTime);
  }
