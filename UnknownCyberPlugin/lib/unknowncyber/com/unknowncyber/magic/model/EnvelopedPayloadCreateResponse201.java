...
import com.unknowncyber.magic.model.PayloadCreateResponse;
...
public class EnvelopedPayloadCreateResponse201 implements Serializable{
  ...
  private PayloadCreateResponse resource = null;

  public EnvelopedPayloadCreateResponse201 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedPayloadCreateResponse201 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedPayloadCreateResponse201 message(String message) {
  ...
  **/
  ...
  public EnvelopedPayloadCreateResponse201 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedPayloadCreateResponse201 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedPayloadCreateResponse201 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedPayloadCreateResponse201 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedPayloadCreateResponse201 resource(PayloadCreateResponse resource) {
  ...
  **/
  @Schema(required = true, description = "")
  public PayloadCreateResponse getResource() {
    return resource;
  }

  public void setResource(PayloadCreateResponse resource) {
    this.resource = resource;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedPayloadCreateResponse201 envelopedPayloadCreateResponse201 = (EnvelopedPayloadCreateResponse201) o;
    return Objects.equals(this.success, envelopedPayloadCreateResponse201.success) &&
        Objects.equals(this.status, envelopedPayloadCreateResponse201.status) &&
        Objects.equals(this.message, envelopedPayloadCreateResponse201.message) &&
        Objects.equals(this.errors, envelopedPayloadCreateResponse201.errors) &&
        Objects.equals(this.links, envelopedPayloadCreateResponse201.links) &&
        Objects.equals(this.resource, envelopedPayloadCreateResponse201.resource);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedPayloadCreateResponse201 {\n");
