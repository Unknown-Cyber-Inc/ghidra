...
import com.unknowncyber.magic.model.AvScanResult;
...
public class FileAvscan implements Serializable{
  ...
  @JsonProperty("scans")
  private List<AvScanResult> scans = null;
  ...
  private Integer positives = null;
  ...
  **/
  @Schema(description = "")
  public List<AvScanResult> getScans() {
    return scans;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FileAvscan fileAvscan = (FileAvscan) o;
    return Objects.equals(this.md5, fileAvscan.md5) &&
        Objects.equals(this.sha1, fileAvscan.sha1) &&
        Objects.equals(this.sha256, fileAvscan.sha256) &&
        Objects.equals(this.sha512, fileAvscan.sha512) &&
        Objects.equals(this.permalink, fileAvscan.permalink) &&
        Objects.equals(this.responseCode, fileAvscan.responseCode) &&
        Objects.equals(this.scans, fileAvscan.scans) &&
        Objects.equals(this.scanDate, fileAvscan.scanDate) &&
        Objects.equals(this.scanId, fileAvscan.scanId) &&
        Objects.equals(this.positives, fileAvscan.positives) &&
        Objects.equals(this.total, fileAvscan.total) &&
        Objects.equals(this.verboseMsg, fileAvscan.verboseMsg);
  }

  @Override
  public int hashCode() {
    return Objects.hash(md5, sha1, sha256, sha512, permalink, responseCode, scans, scanDate, scanId, positives, total, verboseMsg);
  }
  ...
  public String toString() {
    ...
    sb.append("    verboseMsg: ").append(toIndentedString(verboseMsg)).append("\n");
    sb.append("}");
    return sb.toString();
  }
