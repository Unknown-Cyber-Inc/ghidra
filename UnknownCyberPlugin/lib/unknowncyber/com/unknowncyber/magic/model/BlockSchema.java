...
public class BlockSchema implements Serializable{
  ...
  private List<String> genCode = null;

  @JsonProperty("semantics")
  private List<String> semantics = null;

  @JsonProperty("gen_semantics")
  private List<String> genSemantics = null;
  ...
  **/
  @Schema(description = "")
  public List<String> getGenSemantics() {
    return genSemantics;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.startEA, blockSchema.startEA) &&
        Objects.equals(this.endEA, blockSchema.endEA) &&
        Objects.equals(this.bytes, blockSchema.bytes) &&
        Objects.equals(this.code, blockSchema.code) &&
        Objects.equals(this.genCode, blockSchema.genCode) &&
        Objects.equals(this.semantics, blockSchema.semantics) &&
        Objects.equals(this.genSemantics, blockSchema.genSemantics);
  }

  @Override
  public int hashCode() {
    return Objects.hash(startEA, endEA, bytes, code, genCode, semantics, genSemantics);
  }
