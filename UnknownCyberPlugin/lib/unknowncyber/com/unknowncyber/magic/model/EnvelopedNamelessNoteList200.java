...
public class EnvelopedNamelessNoteList200 implements Serializable, EnvelopedNamelessNoteList200EnvelopedIdList200 {
  ...
  private List<NamelessNote> resources = new ArrayList<NamelessNote>();

  public EnvelopedNamelessNoteList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedNamelessNoteList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedNamelessNoteList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedNamelessNoteList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedNamelessNoteList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedNamelessNoteList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedNamelessNoteList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedNamelessNoteList200 resources(List<NamelessNote> resources) {
    this.resources = resources;
    return this;
  }

  public EnvelopedNamelessNoteList200 addResourcesItem(NamelessNote resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<NamelessNote> getResources() {
    return resources;
  }

  public void setResources(List<NamelessNote> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedNamelessNoteList200 envelopedNamelessNoteList200 = (EnvelopedNamelessNoteList200) o;
    return Objects.equals(this.success, envelopedNamelessNoteList200.success) &&
        Objects.equals(this.status, envelopedNamelessNoteList200.status) &&
        Objects.equals(this.message, envelopedNamelessNoteList200.message) &&
        Objects.equals(this.errors, envelopedNamelessNoteList200.errors) &&
        Objects.equals(this.links, envelopedNamelessNoteList200.links) &&
        Objects.equals(this.resources, envelopedNamelessNoteList200.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedNamelessNoteList200 {\n");
