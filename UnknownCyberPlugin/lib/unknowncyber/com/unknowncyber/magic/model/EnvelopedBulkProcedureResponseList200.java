...
import com.unknowncyber.magic.model.BulkProcedureResponse;
...
public class EnvelopedBulkProcedureResponseList200 implements Serializable{
  ...
  private List<BulkProcedureResponse> resources = new ArrayList<BulkProcedureResponse>();

  public EnvelopedBulkProcedureResponseList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedBulkProcedureResponseList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedBulkProcedureResponseList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedBulkProcedureResponseList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedBulkProcedureResponseList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedBulkProcedureResponseList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedBulkProcedureResponseList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedBulkProcedureResponseList200 resources(List<BulkProcedureResponse> resources) {
    this.resources = resources;
    return this;
  }

  public EnvelopedBulkProcedureResponseList200 addResourcesItem(BulkProcedureResponse resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<BulkProcedureResponse> getResources() {
    return resources;
  }

  public void setResources(List<BulkProcedureResponse> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedBulkProcedureResponseList200 envelopedBulkProcedureResponseList200 = (EnvelopedBulkProcedureResponseList200) o;
    return Objects.equals(this.success, envelopedBulkProcedureResponseList200.success) &&
        Objects.equals(this.status, envelopedBulkProcedureResponseList200.status) &&
        Objects.equals(this.message, envelopedBulkProcedureResponseList200.message) &&
        Objects.equals(this.errors, envelopedBulkProcedureResponseList200.errors) &&
        Objects.equals(this.links, envelopedBulkProcedureResponseList200.links) &&
        Objects.equals(this.resources, envelopedBulkProcedureResponseList200.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedBulkProcedureResponseList200 {\n");
