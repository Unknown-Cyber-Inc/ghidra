...
public class UnauthenticatedResponse implements Serializable{
  ...
  public UnauthenticatedResponse success(Boolean success) {
  ...
  **/
  ...
  public UnauthenticatedResponse status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public UnauthenticatedResponse errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public UnauthenticatedResponse addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public UnauthenticatedResponse links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public UnauthenticatedResponse putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.success, unauthenticatedResponse.success) &&
        Objects.equals(this.status, unauthenticatedResponse.status) &&
        Objects.equals(this.message, unauthenticatedResponse.message) &&
        Objects.equals(this.errors, unauthenticatedResponse.errors) &&
        Objects.equals(this.links, unauthenticatedResponse.links);
  }
