...
public class RepData implements Serializable{
  ...
  @JsonProperty("comes_from")
  private List<String> comesFrom = null;

  @JsonProperty("last_updated")
  private Date lastUpdated = null;

  public RepData sha1(String sha1) {
    this.sha1 = sha1;
    return this;
  }
  ...
  **/
  ...
  public RepData reputation(String reputation) {
  ...
  **/
  ...
  public RepData tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public RepData addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public RepData notes(List<String> notes) {
    this.notes = notes;
    return this;
  }

  public RepData addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  @Schema(description = "")
  public List<String> getComesFrom() {
    return comesFrom;
  }

  public RepData lastUpdated(Date lastUpdated) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.sha1, repData.sha1) &&
        Objects.equals(this.reputation, repData.reputation) &&
        Objects.equals(this.tags, repData.tags) &&
        Objects.equals(this.notes, repData.notes) &&
        Objects.equals(this.comesFrom, repData.comesFrom) &&
        Objects.equals(this.lastUpdated, repData.lastUpdated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sha1, reputation, tags, notes, comesFrom, lastUpdated);
  }
