...
public class EnvelopedFileResponse201 implements Serializable{
  ...
  private FileResponse resource = null;

  public EnvelopedFileResponse201 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedFileResponse201 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedFileResponse201 message(String message) {
  ...
  **/
  ...
  public EnvelopedFileResponse201 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedFileResponse201 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedFileResponse201 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedFileResponse201 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedFileResponse201 resource(FileResponse resource) {
  ...
  **/
  @Schema(required = true, description = "")
  public FileResponse getResource() {
    return resource;
  }

  public void setResource(FileResponse resource) {
    this.resource = resource;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedFileResponse201 envelopedFileResponse201 = (EnvelopedFileResponse201) o;
    return Objects.equals(this.success, envelopedFileResponse201.success) &&
        Objects.equals(this.status, envelopedFileResponse201.status) &&
        Objects.equals(this.message, envelopedFileResponse201.message) &&
        Objects.equals(this.errors, envelopedFileResponse201.errors) &&
        Objects.equals(this.links, envelopedFileResponse201.links) &&
        Objects.equals(this.resource, envelopedFileResponse201.resource);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedFileResponse201 {\n");
