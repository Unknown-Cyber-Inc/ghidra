...
public class EnvelopedNoteList200 implements Serializable{
  ...
  private List<Note> resources = new ArrayList<Note>();

  public EnvelopedNoteList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedNoteList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedNoteList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedNoteList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedNoteList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedNoteList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedNoteList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedNoteList200 resources(List<Note> resources) {
    this.resources = resources;
    return this;
  }

  public EnvelopedNoteList200 addResourcesItem(Note resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<Note> getResources() {
    return resources;
  }

  public void setResources(List<Note> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedNoteList200 envelopedNoteList200 = (EnvelopedNoteList200) o;
    return Objects.equals(this.success, envelopedNoteList200.success) &&
        Objects.equals(this.status, envelopedNoteList200.status) &&
        Objects.equals(this.message, envelopedNoteList200.message) &&
        Objects.equals(this.errors, envelopedNoteList200.errors) &&
        Objects.equals(this.links, envelopedNoteList200.links) &&
        Objects.equals(this.resources, envelopedNoteList200.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedNoteList200 {\n");
