...
import com.unknowncyber.magic.model.FileIndicatorResponse;
...
public class EnvelopedFileIndicatorResponseList200 implements Serializable{
  ...
  private List<FileIndicatorResponse> resources = new ArrayList<FileIndicatorResponse>();

  public EnvelopedFileIndicatorResponseList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedFileIndicatorResponseList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedFileIndicatorResponseList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedFileIndicatorResponseList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedFileIndicatorResponseList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedFileIndicatorResponseList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedFileIndicatorResponseList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedFileIndicatorResponseList200 resources(List<FileIndicatorResponse> resources) {
    this.resources = resources;
    return this;
  }

  public EnvelopedFileIndicatorResponseList200 addResourcesItem(FileIndicatorResponse resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<FileIndicatorResponse> getResources() {
    return resources;
  }

  public void setResources(List<FileIndicatorResponse> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedFileIndicatorResponseList200 envelopedFileIndicatorResponseList200 = (EnvelopedFileIndicatorResponseList200) o;
    return Objects.equals(this.success, envelopedFileIndicatorResponseList200.success) &&
        Objects.equals(this.status, envelopedFileIndicatorResponseList200.status) &&
        Objects.equals(this.message, envelopedFileIndicatorResponseList200.message) &&
        Objects.equals(this.errors, envelopedFileIndicatorResponseList200.errors) &&
        Objects.equals(this.links, envelopedFileIndicatorResponseList200.links) &&
        Objects.equals(this.resources, envelopedFileIndicatorResponseList200.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedFileIndicatorResponseList200 {\n");
