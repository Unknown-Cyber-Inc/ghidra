...
import com.unknowncyber.magic.model.SearchCountResponse;
...
public class EnvelopedSearchCountResponseList200 implements Serializable{
  ...
  private List<SearchCountResponse> resources = new ArrayList<SearchCountResponse>();

  public EnvelopedSearchCountResponseList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedSearchCountResponseList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedSearchCountResponseList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedSearchCountResponseList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedSearchCountResponseList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedSearchCountResponseList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedSearchCountResponseList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedSearchCountResponseList200 resources(List<SearchCountResponse> resources) {
    this.resources = resources;
    return this;
  }

  public EnvelopedSearchCountResponseList200 addResourcesItem(SearchCountResponse resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<SearchCountResponse> getResources() {
    return resources;
  }

  public void setResources(List<SearchCountResponse> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedSearchCountResponseList200 envelopedSearchCountResponseList200 = (EnvelopedSearchCountResponseList200) o;
    return Objects.equals(this.success, envelopedSearchCountResponseList200.success) &&
        Objects.equals(this.status, envelopedSearchCountResponseList200.status) &&
        Objects.equals(this.message, envelopedSearchCountResponseList200.message) &&
        Objects.equals(this.errors, envelopedSearchCountResponseList200.errors) &&
        Objects.equals(this.links, envelopedSearchCountResponseList200.links) &&
        Objects.equals(this.resources, envelopedSearchCountResponseList200.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedSearchCountResponseList200 {\n");
