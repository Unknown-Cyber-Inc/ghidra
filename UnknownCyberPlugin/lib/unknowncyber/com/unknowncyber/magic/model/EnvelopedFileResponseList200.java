...
import com.unknowncyber.magic.model.FileResponse;
...
public class EnvelopedFileResponseList200 implements Serializable{
  ...
  private List<FileResponse> resources = new ArrayList<FileResponse>();

  public EnvelopedFileResponseList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedFileResponseList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedFileResponseList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedFileResponseList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedFileResponseList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedFileResponseList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedFileResponseList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedFileResponseList200 resources(List<FileResponse> resources) {
    this.resources = resources;
    return this;
  }

  public EnvelopedFileResponseList200 addResourcesItem(FileResponse resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<FileResponse> getResources() {
    return resources;
  }

  public void setResources(List<FileResponse> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedFileResponseList200 envelopedFileResponseList200 = (EnvelopedFileResponseList200) o;
    return Objects.equals(this.success, envelopedFileResponseList200.success) &&
        Objects.equals(this.status, envelopedFileResponseList200.status) &&
        Objects.equals(this.message, envelopedFileResponseList200.message) &&
        Objects.equals(this.errors, envelopedFileResponseList200.errors) &&
        Objects.equals(this.links, envelopedFileResponseList200.links) &&
        Objects.equals(this.resources, envelopedFileResponseList200.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedFileResponseList200 {\n");
