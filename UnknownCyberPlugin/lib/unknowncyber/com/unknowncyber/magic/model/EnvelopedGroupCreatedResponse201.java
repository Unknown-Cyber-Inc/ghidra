...
import com.unknowncyber.magic.model.GroupCreatedResponse;
...
public class EnvelopedGroupCreatedResponse201 implements Serializable{
  ...
  private GroupCreatedResponse resource = null;

  public EnvelopedGroupCreatedResponse201 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedGroupCreatedResponse201 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedGroupCreatedResponse201 message(String message) {
  ...
  **/
  ...
  public EnvelopedGroupCreatedResponse201 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedGroupCreatedResponse201 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedGroupCreatedResponse201 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedGroupCreatedResponse201 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedGroupCreatedResponse201 resource(GroupCreatedResponse resource) {
  ...
  **/
  @Schema(required = true, description = "")
  public GroupCreatedResponse getResource() {
    return resource;
  }

  public void setResource(GroupCreatedResponse resource) {
    this.resource = resource;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedGroupCreatedResponse201 envelopedGroupCreatedResponse201 = (EnvelopedGroupCreatedResponse201) o;
    return Objects.equals(this.success, envelopedGroupCreatedResponse201.success) &&
        Objects.equals(this.status, envelopedGroupCreatedResponse201.status) &&
        Objects.equals(this.message, envelopedGroupCreatedResponse201.message) &&
        Objects.equals(this.errors, envelopedGroupCreatedResponse201.errors) &&
        Objects.equals(this.links, envelopedGroupCreatedResponse201.links) &&
        Objects.equals(this.resource, envelopedGroupCreatedResponse201.resource);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedGroupCreatedResponse201 {\n");
