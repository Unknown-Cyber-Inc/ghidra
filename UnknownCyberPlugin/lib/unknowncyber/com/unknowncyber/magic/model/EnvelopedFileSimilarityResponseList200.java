...
import com.unknowncyber.magic.model.FileSimilarityResponse;
...
public class EnvelopedFileSimilarityResponseList200 implements Serializable{
  ...
  public EnvelopedFileSimilarityResponseList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedFileSimilarityResponseList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedFileSimilarityResponseList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedFileSimilarityResponseList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedFileSimilarityResponseList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedFileSimilarityResponseList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedFileSimilarityResponseList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedFileSimilarityResponseList200 addResourcesItem(FileSimilarityResponse resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<FileSimilarityResponse> getResources() {
    return resources;
  }

  public void setResources(List<FileSimilarityResponse> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedFileSimilarityResponseList200 envelopedFileSimilarityResponseList200 = (EnvelopedFileSimilarityResponseList200) o;
    return Objects.equals(this.success, envelopedFileSimilarityResponseList200.success) &&
        Objects.equals(this.status, envelopedFileSimilarityResponseList200.status) &&
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedFileSimilarityResponseList200 {\n");
