...
public class EnvelopedProcedureResponse200 implements Serializable{
  ...
  private ProcedureResponse resource = null;

  public EnvelopedProcedureResponse200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedProcedureResponse200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedProcedureResponse200 message(String message) {
  ...
  **/
  ...
  public EnvelopedProcedureResponse200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedProcedureResponse200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedProcedureResponse200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedProcedureResponse200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedProcedureResponse200 resource(ProcedureResponse resource) {
  ...
  **/
  @Schema(required = true, description = "")
  public ProcedureResponse getResource() {
    return resource;
  }

  public void setResource(ProcedureResponse resource) {
    this.resource = resource;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedProcedureResponse200 envelopedProcedureResponse200 = (EnvelopedProcedureResponse200) o;
    return Objects.equals(this.success, envelopedProcedureResponse200.success) &&
        Objects.equals(this.status, envelopedProcedureResponse200.status) &&
        Objects.equals(this.message, envelopedProcedureResponse200.message) &&
        Objects.equals(this.errors, envelopedProcedureResponse200.errors) &&
        Objects.equals(this.links, envelopedProcedureResponse200.links) &&
        Objects.equals(this.resource, envelopedProcedureResponse200.resource);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedProcedureResponse200 {\n");
