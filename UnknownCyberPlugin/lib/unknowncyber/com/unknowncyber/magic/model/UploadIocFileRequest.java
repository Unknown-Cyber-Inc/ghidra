...
public class UploadIocFileRequest implements Serializable{
  private static final long serialVersionUID = 1L;
  @JsonProperty("filedata")
  private File filedata = null;

  public UploadIocFileRequest filedata(File filedata) {
    this.filedata = filedata;
    return this;
  }

   /**
   * CSV or text file containing IoCs
   * @return filedata
  **/
  @Schema(required = true, description = "CSV or text file containing IoCs")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UploadIocFileRequest uploadIocFileRequest = (UploadIocFileRequest) o;
    return Objects.equals(this.filedata, uploadIocFileRequest.filedata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(Objects.hashCode(filedata));
  }
  ...
  public String toString() {
    ...
    sb.append("class UploadIocFileRequest {\n");
