...
public class EnvelopedEmpty201 implements Serializable{
  ...
  public EnvelopedEmpty201 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedEmpty201 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedEmpty201 message(String message) {
  ...
  **/
  ...
  public EnvelopedEmpty201 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedEmpty201 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedEmpty201 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedEmpty201 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedEmpty201 envelopedEmpty201 = (EnvelopedEmpty201) o;
    return Objects.equals(this.success, envelopedEmpty201.success) &&
        Objects.equals(this.status, envelopedEmpty201.status) &&
        Objects.equals(this.message, envelopedEmpty201.message) &&
        Objects.equals(this.errors, envelopedEmpty201.errors) &&
        Objects.equals(this.links, envelopedEmpty201.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(success, status, message, errors, links);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedEmpty201 {\n");
