...
import com.unknowncyber.magic.model.IndicatorFileUploadResponse;
...
public class EnvelopedIndicatorFileUploadResponse200 implements Serializable{
  ...
  private IndicatorFileUploadResponse resource = null;

  public EnvelopedIndicatorFileUploadResponse200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedIndicatorFileUploadResponse200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedIndicatorFileUploadResponse200 message(String message) {
  ...
  **/
  ...
  public EnvelopedIndicatorFileUploadResponse200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedIndicatorFileUploadResponse200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedIndicatorFileUploadResponse200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedIndicatorFileUploadResponse200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedIndicatorFileUploadResponse200 resource(IndicatorFileUploadResponse resource) {
  ...
  **/
  @Schema(required = true, description = "")
  public IndicatorFileUploadResponse getResource() {
    return resource;
  }

  public void setResource(IndicatorFileUploadResponse resource) {
    this.resource = resource;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedIndicatorFileUploadResponse200 envelopedIndicatorFileUploadResponse200 = (EnvelopedIndicatorFileUploadResponse200) o;
    return Objects.equals(this.success, envelopedIndicatorFileUploadResponse200.success) &&
        Objects.equals(this.status, envelopedIndicatorFileUploadResponse200.status) &&
        Objects.equals(this.message, envelopedIndicatorFileUploadResponse200.message) &&
        Objects.equals(this.errors, envelopedIndicatorFileUploadResponse200.errors) &&
        Objects.equals(this.links, envelopedIndicatorFileUploadResponse200.links) &&
        Objects.equals(this.resource, envelopedIndicatorFileUploadResponse200.resource);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedIndicatorFileUploadResponse200 {\n");
