...
import com.unknowncyber.magic.model.FileGenomicsResponse;
...
public class EnvelopedFileGenomicsResponse200 implements Serializable{
  ...
  private FileGenomicsResponse resource = null;

  public EnvelopedFileGenomicsResponse200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedFileGenomicsResponse200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedFileGenomicsResponse200 message(String message) {
  ...
  **/
  ...
  public EnvelopedFileGenomicsResponse200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedFileGenomicsResponse200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedFileGenomicsResponse200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedFileGenomicsResponse200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedFileGenomicsResponse200 resource(FileGenomicsResponse resource) {
  ...
  **/
  @Schema(required = true, description = "")
  public FileGenomicsResponse getResource() {
    return resource;
  }

  public void setResource(FileGenomicsResponse resource) {
    this.resource = resource;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedFileGenomicsResponse200 envelopedFileGenomicsResponse200 = (EnvelopedFileGenomicsResponse200) o;
    return Objects.equals(this.success, envelopedFileGenomicsResponse200.success) &&
        Objects.equals(this.status, envelopedFileGenomicsResponse200.status) &&
        Objects.equals(this.message, envelopedFileGenomicsResponse200.message) &&
        Objects.equals(this.errors, envelopedFileGenomicsResponse200.errors) &&
        Objects.equals(this.links, envelopedFileGenomicsResponse200.links) &&
        Objects.equals(this.resource, envelopedFileGenomicsResponse200.resource);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedFileGenomicsResponse200 {\n");
