...
import com.unknowncyber.magic.model.GroupReducedResponse;
...
public class EnvelopedGroupReducedResponseList200 implements Serializable{
  ...
  private List<GroupReducedResponse> resources = new ArrayList<GroupReducedResponse>();

  public EnvelopedGroupReducedResponseList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedGroupReducedResponseList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedGroupReducedResponseList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedGroupReducedResponseList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedGroupReducedResponseList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedGroupReducedResponseList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedGroupReducedResponseList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedGroupReducedResponseList200 resources(List<GroupReducedResponse> resources) {
    this.resources = resources;
    return this;
  }

  public EnvelopedGroupReducedResponseList200 addResourcesItem(GroupReducedResponse resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<GroupReducedResponse> getResources() {
    return resources;
  }

  public void setResources(List<GroupReducedResponse> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedGroupReducedResponseList200 envelopedGroupReducedResponseList200 = (EnvelopedGroupReducedResponseList200) o;
    return Objects.equals(this.success, envelopedGroupReducedResponseList200.success) &&
        Objects.equals(this.status, envelopedGroupReducedResponseList200.status) &&
        Objects.equals(this.message, envelopedGroupReducedResponseList200.message) &&
        Objects.equals(this.errors, envelopedGroupReducedResponseList200.errors) &&
        Objects.equals(this.links, envelopedGroupReducedResponseList200.links) &&
        Objects.equals(this.resources, envelopedGroupReducedResponseList200.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedGroupReducedResponseList200 {\n");
