...
public class EnvelopedTagCreatedResponse201 implements Serializable{
  ...
  private TagCreatedResponse resource = null;

  public EnvelopedTagCreatedResponse201 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedTagCreatedResponse201 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedTagCreatedResponse201 message(String message) {
  ...
  **/
  ...
  public EnvelopedTagCreatedResponse201 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedTagCreatedResponse201 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedTagCreatedResponse201 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedTagCreatedResponse201 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedTagCreatedResponse201 resource(TagCreatedResponse resource) {
  ...
  **/
  @Schema(required = true, description = "")
  public TagCreatedResponse getResource() {
    return resource;
  }

  public void setResource(TagCreatedResponse resource) {
    this.resource = resource;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedTagCreatedResponse201 envelopedTagCreatedResponse201 = (EnvelopedTagCreatedResponse201) o;
    return Objects.equals(this.success, envelopedTagCreatedResponse201.success) &&
        Objects.equals(this.status, envelopedTagCreatedResponse201.status) &&
        Objects.equals(this.message, envelopedTagCreatedResponse201.message) &&
        Objects.equals(this.errors, envelopedTagCreatedResponse201.errors) &&
        Objects.equals(this.links, envelopedTagCreatedResponse201.links) &&
        Objects.equals(this.resource, envelopedTagCreatedResponse201.resource);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedTagCreatedResponse201 {\n");
