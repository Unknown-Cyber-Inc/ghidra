...
public class EnvelopedNote201 implements Serializable{
  ...
  private Note resource = null;

  public EnvelopedNote201 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedNote201 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedNote201 message(String message) {
  ...
  **/
  ...
  public EnvelopedNote201 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedNote201 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedNote201 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedNote201 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedNote201 resource(Note resource) {
  ...
  **/
  @Schema(required = true, description = "")
  public Note getResource() {
    return resource;
  }

  public void setResource(Note resource) {
    this.resource = resource;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedNote201 envelopedNote201 = (EnvelopedNote201) o;
    return Objects.equals(this.success, envelopedNote201.success) &&
        Objects.equals(this.status, envelopedNote201.status) &&
        Objects.equals(this.message, envelopedNote201.message) &&
        Objects.equals(this.errors, envelopedNote201.errors) &&
        Objects.equals(this.links, envelopedNote201.links) &&
        Objects.equals(this.resource, envelopedNote201.resource);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedNote201 {\n");
