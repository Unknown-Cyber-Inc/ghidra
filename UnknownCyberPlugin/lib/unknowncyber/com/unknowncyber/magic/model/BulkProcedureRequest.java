...
public class BulkProcedureRequest implements Serializable{
  private static final long serialVersionUID = 1L;
  @JsonProperty("ids")
  private List<String> ids = new ArrayList<String>();

  public BulkProcedureRequest ids(List<String> ids) {
    this.ids = ids;
    return this;
  }

  public BulkProcedureRequest addIdsItem(String idsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BulkProcedureRequest bulkProcedureRequest = (BulkProcedureRequest) o;
    return Objects.equals(this.ids, bulkProcedureRequest.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class BulkProcedureRequest {\n");
