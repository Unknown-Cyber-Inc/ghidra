...
import com.unknowncyber.magic.model.FileStringsResponse;
...
public class EnvelopedFileStringsResponseList200 implements Serializable{
  ...
  private List<FileStringsResponse> resources = new ArrayList<FileStringsResponse>();

  public EnvelopedFileStringsResponseList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedFileStringsResponseList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedFileStringsResponseList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedFileStringsResponseList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedFileStringsResponseList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedFileStringsResponseList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedFileStringsResponseList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedFileStringsResponseList200 resources(List<FileStringsResponse> resources) {
    this.resources = resources;
    return this;
  }

  public EnvelopedFileStringsResponseList200 addResourcesItem(FileStringsResponse resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<FileStringsResponse> getResources() {
    return resources;
  }

  public void setResources(List<FileStringsResponse> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedFileStringsResponseList200 envelopedFileStringsResponseList200 = (EnvelopedFileStringsResponseList200) o;
    return Objects.equals(this.success, envelopedFileStringsResponseList200.success) &&
        Objects.equals(this.status, envelopedFileStringsResponseList200.status) &&
        Objects.equals(this.message, envelopedFileStringsResponseList200.message) &&
        Objects.equals(this.errors, envelopedFileStringsResponseList200.errors) &&
        Objects.equals(this.links, envelopedFileStringsResponseList200.links) &&
        Objects.equals(this.resources, envelopedFileStringsResponseList200.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedFileStringsResponseList200 {\n");
