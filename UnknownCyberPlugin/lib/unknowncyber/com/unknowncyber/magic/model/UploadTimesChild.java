...
public class UploadTimesChild implements Serializable{
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UploadTimesChild uploadTimesChild = (UploadTimesChild) o;
    return Objects.equals(this.time, uploadTimesChild.time) &&
        Objects.equals(this.user, uploadTimesChild.user) &&
        Objects.equals(this.name, uploadTimesChild.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(time, user, name);
  }
  ...
  public String toString() {
    ...
    sb.append("class UploadTimesChild {\n");
