...
import com.unknowncyber.magic.model.InferredData;
import com.unknowncyber.magic.model.RepData;
...
public class FileReputationResponse implements Serializable{
  private static final long serialVersionUID = 1L;
  @JsonProperty("reputation")
  private String reputation = "malicious";

  @JsonProperty("inferred_reputation")
  private String inferredReputation = "malicious";

  @JsonProperty("reputation_data")
  private List<RepData> reputationData = null;

  @JsonProperty("inferred_checked_criteria")
  private List<InferredData> inferredCheckedCriteria = null;

  public FileReputationResponse reputation(String reputation) {
  ...
  **/
  ...
  public FileReputationResponse inferredReputation(String inferredReputation) {
    this.inferredReputation = inferredReputation;
    return this;
  }

   /**
   * Get inferredReputation
   * @return inferredReputation
  **/
  @Schema(description = "")
  public String getInferredReputation() {
    return inferredReputation;
  }

  public void setInferredReputation(String inferredReputation) {
    this.inferredReputation = inferredReputation;
  }
  ...
  **/
  @Schema(description = "")
  public List<RepData> getReputationData() {
    return reputationData;
  }

   /**
   * Get inferredCheckedCriteria
   * @return inferredCheckedCriteria
  **/
  @Schema(description = "")
  public List<InferredData> getInferredCheckedCriteria() {
    return inferredCheckedCriteria;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FileReputationResponse fileReputationResponse = (FileReputationResponse) o;
    return Objects.equals(this.reputation, fileReputationResponse.reputation) &&
        Objects.equals(this.inferredReputation, fileReputationResponse.inferredReputation) &&
        Objects.equals(this.reputationData, fileReputationResponse.reputationData) &&
        Objects.equals(this.inferredCheckedCriteria, fileReputationResponse.inferredCheckedCriteria);
  }

  @Override
  public int hashCode() {
    return Objects.hash(reputation, inferredReputation, reputationData, inferredCheckedCriteria);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileReputationResponse {\n");
    
    sb.append("    reputation: ").append(toIndentedString(reputation)).append("\n");
    sb.append("    inferredReputation: ").append(toIndentedString(inferredReputation)).append("\n");
    sb.append("    reputationData: ").append(toIndentedString(reputationData)).append("\n");
    sb.append("    inferredCheckedCriteria: ").append(toIndentedString(inferredCheckedCriteria)).append("\n");
    sb.append("}");
    return sb.toString();
  }
