...
public class EnvelopedFileList200 implements Serializable, EnvelopedFileList200EnvelopedFileChildList200, EnvelopedFileList200EnvelopedIdList200 {
  ...
  public EnvelopedFileList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedFileList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedFileList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedFileList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedFileList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedFileList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedFileList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedFileList200 addResourcesItem(File resourcesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedFileList200 envelopedFileList200 = (EnvelopedFileList200) o;
    return Objects.equals(this.success, envelopedFileList200.success) &&
        Objects.equals(this.status, envelopedFileList200.status) &&
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedFileList200 {\n");
