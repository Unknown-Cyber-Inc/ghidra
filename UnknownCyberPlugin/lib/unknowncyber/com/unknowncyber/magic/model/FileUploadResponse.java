...
public class FileUploadResponse implements Serializable{
  ...
  @JsonProperty("_self")
  private String _self = "https://api.magic.unknowncyber.com/v2/files/ce46741bf67591f5f60b7a74dec3ef8d648ca9c6";

  @JsonProperty("sha1")
  private String sha1 = "ce46741bf67591f5f60b7a74dec3ef8d648ca9c6";

  @JsonProperty("filename")
  private String filename = "myFile.exe";

  @JsonProperty("filesize")
  private Integer filesize = 365480;

  @JsonProperty("filetype")
  private String filetype = "PE32+ executable (GUI) x86-64, for MS Windows";

  @JsonProperty("job_id")
  private String jobId = "6d4a1164-7e4f-4bdd-951f-d302ef07f12a";

  @JsonProperty("message")
  private String message = "File Uploaded";

  @JsonProperty("mimetype")
  private String mimetype = "application/x-msdownload";

  @JsonProperty("object_class")
  private String objectClass = "binary.pe32+";

  @JsonProperty("status")
  private Integer status = 201;

  public FileUploadResponse _self(String _self) {
    this._self = _self;
    return this;
  }
  ...
  **/
  ...
  public FileUploadResponse sha1(String sha1) {
    this.sha1 = sha1;
    return this;
  }
  ...
  **/
  ...
  public FileUploadResponse filesize(Integer filesize) {
  ...
  **/
  ...
  public FileUploadResponse filetype(String filetype) {
  ...
  **/
  ...
  public FileUploadResponse jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  **/
  ...
  public FileUploadResponse message(String message) {
  ...
  **/
  ...
  public FileUploadResponse mimetype(String mimetype) {
  ...
  **/
  ...
  public FileUploadResponse objectClass(String objectClass) {
  ...
  **/
  ...
  public FileUploadResponse status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this._self, fileUploadResponse._self) &&
        Objects.equals(this.sha1, fileUploadResponse.sha1) &&
        Objects.equals(this.filename, fileUploadResponse.filename) &&
        Objects.equals(this.filesize, fileUploadResponse.filesize) &&
        Objects.equals(this.filetype, fileUploadResponse.filetype) &&
        Objects.equals(this.jobId, fileUploadResponse.jobId) &&
        Objects.equals(this.message, fileUploadResponse.message) &&
        Objects.equals(this.mimetype, fileUploadResponse.mimetype) &&
        Objects.equals(this.objectClass, fileUploadResponse.objectClass) &&
        Objects.equals(this.status, fileUploadResponse.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_self, sha1, filename, filesize, filetype, jobId, message, mimetype, objectClass, status);
  }
