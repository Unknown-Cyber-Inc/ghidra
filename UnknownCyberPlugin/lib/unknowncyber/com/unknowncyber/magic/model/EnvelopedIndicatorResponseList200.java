...
import com.unknowncyber.magic.model.IndicatorResponse;
...
public class EnvelopedIndicatorResponseList200 implements Serializable{
  ...
  private List<IndicatorResponse> resources = new ArrayList<IndicatorResponse>();

  public EnvelopedIndicatorResponseList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedIndicatorResponseList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedIndicatorResponseList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedIndicatorResponseList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedIndicatorResponseList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedIndicatorResponseList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedIndicatorResponseList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedIndicatorResponseList200 resources(List<IndicatorResponse> resources) {
    this.resources = resources;
    return this;
  }

  public EnvelopedIndicatorResponseList200 addResourcesItem(IndicatorResponse resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<IndicatorResponse> getResources() {
    return resources;
  }

  public void setResources(List<IndicatorResponse> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedIndicatorResponseList200 envelopedIndicatorResponseList200 = (EnvelopedIndicatorResponseList200) o;
    return Objects.equals(this.success, envelopedIndicatorResponseList200.success) &&
        Objects.equals(this.status, envelopedIndicatorResponseList200.status) &&
        Objects.equals(this.message, envelopedIndicatorResponseList200.message) &&
        Objects.equals(this.errors, envelopedIndicatorResponseList200.errors) &&
        Objects.equals(this.links, envelopedIndicatorResponseList200.links) &&
        Objects.equals(this.resources, envelopedIndicatorResponseList200.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedIndicatorResponseList200 {\n");
