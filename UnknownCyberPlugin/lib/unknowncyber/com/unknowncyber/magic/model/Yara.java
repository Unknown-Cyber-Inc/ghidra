...
public class Yara implements Serializable{
  ...
  public Yara files(List<String> files) {
    this.files = files;
    return this;
  }

  public Yara addFilesItem(String filesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Yara yara = (Yara) o;
    return Objects.equals(this.files, yara.files) &&
        Objects.equals(this.name, yara.name) &&
        Objects.equals(this.rule, yara.rule) &&
        Objects.equals(this.magicYaraId, yara.magicYaraId) &&
        Objects.equals(this.magicCriteriaId, yara.magicCriteriaId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(files, name, rule, magicYaraId, magicCriteriaId);
  }
