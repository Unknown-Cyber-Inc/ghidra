...
public class EnvelopedProcedureList200 implements Serializable{
  ...
  private List<Procedure> resources = new ArrayList<Procedure>();

  public EnvelopedProcedureList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedProcedureList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedProcedureList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedProcedureList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedProcedureList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedProcedureList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedProcedureList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedProcedureList200 resources(List<Procedure> resources) {
    this.resources = resources;
    return this;
  }

  public EnvelopedProcedureList200 addResourcesItem(Procedure resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<Procedure> getResources() {
    return resources;
  }

  public void setResources(List<Procedure> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedProcedureList200 envelopedProcedureList200 = (EnvelopedProcedureList200) o;
    return Objects.equals(this.success, envelopedProcedureList200.success) &&
        Objects.equals(this.status, envelopedProcedureList200.status) &&
        Objects.equals(this.message, envelopedProcedureList200.message) &&
        Objects.equals(this.errors, envelopedProcedureList200.errors) &&
        Objects.equals(this.links, envelopedProcedureList200.links) &&
        Objects.equals(this.resources, envelopedProcedureList200.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedProcedureList200 {\n");
