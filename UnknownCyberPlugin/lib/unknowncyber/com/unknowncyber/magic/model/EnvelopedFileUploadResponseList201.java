...
public class EnvelopedFileUploadResponseList201 implements Serializable{
  ...
  private List<FileUploadResponse> resources = new ArrayList<FileUploadResponse>();

  public EnvelopedFileUploadResponseList201 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedFileUploadResponseList201 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedFileUploadResponseList201 message(String message) {
  ...
  **/
  ...
  public EnvelopedFileUploadResponseList201 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedFileUploadResponseList201 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedFileUploadResponseList201 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedFileUploadResponseList201 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedFileUploadResponseList201 resources(List<FileUploadResponse> resources) {
    this.resources = resources;
    return this;
  }

  public EnvelopedFileUploadResponseList201 addResourcesItem(FileUploadResponse resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<FileUploadResponse> getResources() {
    return resources;
  }

  public void setResources(List<FileUploadResponse> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedFileUploadResponseList201 envelopedFileUploadResponseList201 = (EnvelopedFileUploadResponseList201) o;
    return Objects.equals(this.success, envelopedFileUploadResponseList201.success) &&
        Objects.equals(this.status, envelopedFileUploadResponseList201.status) &&
        Objects.equals(this.message, envelopedFileUploadResponseList201.message) &&
        Objects.equals(this.errors, envelopedFileUploadResponseList201.errors) &&
        Objects.equals(this.links, envelopedFileUploadResponseList201.links) &&
        Objects.equals(this.resources, envelopedFileUploadResponseList201.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedFileUploadResponseList201 {\n");
