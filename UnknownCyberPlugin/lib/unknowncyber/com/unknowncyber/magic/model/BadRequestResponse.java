...
public class BadRequestResponse implements Serializable{
  ...
  private String message = "Malformed Parameters";
  ...
  public BadRequestResponse success(Boolean success) {
  ...
  **/
  ...
  public BadRequestResponse status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public BadRequestResponse errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public BadRequestResponse addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public BadRequestResponse links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public BadRequestResponse putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.success, badRequestResponse.success) &&
        Objects.equals(this.status, badRequestResponse.status) &&
        Objects.equals(this.message, badRequestResponse.message) &&
        Objects.equals(this.errors, badRequestResponse.errors) &&
        Objects.equals(this.links, badRequestResponse.links);
  }
