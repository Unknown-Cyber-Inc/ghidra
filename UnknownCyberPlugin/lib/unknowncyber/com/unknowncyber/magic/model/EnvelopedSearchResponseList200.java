...
import com.unknowncyber.magic.model.SearchResponse;
...
public class EnvelopedSearchResponseList200 implements Serializable{
  ...
  private List<SearchResponse> resources = new ArrayList<SearchResponse>();

  public EnvelopedSearchResponseList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedSearchResponseList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedSearchResponseList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedSearchResponseList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedSearchResponseList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedSearchResponseList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedSearchResponseList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedSearchResponseList200 resources(List<SearchResponse> resources) {
    this.resources = resources;
    return this;
  }

  public EnvelopedSearchResponseList200 addResourcesItem(SearchResponse resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<SearchResponse> getResources() {
    return resources;
  }

  public void setResources(List<SearchResponse> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedSearchResponseList200 envelopedSearchResponseList200 = (EnvelopedSearchResponseList200) o;
    return Objects.equals(this.success, envelopedSearchResponseList200.success) &&
        Objects.equals(this.status, envelopedSearchResponseList200.status) &&
        Objects.equals(this.message, envelopedSearchResponseList200.message) &&
        Objects.equals(this.errors, envelopedSearchResponseList200.errors) &&
        Objects.equals(this.links, envelopedSearchResponseList200.links) &&
        Objects.equals(this.resources, envelopedSearchResponseList200.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedSearchResponseList200 {\n");
