...
public class YaraProcedureRequest implements Serializable{
  ...
  @JsonProperty("max_signatures")
  private Integer maxSignatures = null;

  public YaraProcedureRequest procHashes(List<String> procHashes) {
    this.procHashes = procHashes;
    return this;
  }

  public YaraProcedureRequest addProcHashesItem(String procHashesItem) {
  ...
  **/
  ...
  public YaraProcedureRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public YaraProcedureRequest condition(String condition) {
  ...
  **/
  ...
  public YaraProcedureRequest includeAll(Boolean includeAll) {
  ...
  **/
  ...
  public YaraProcedureRequest maxSignatures(Integer maxSignatures) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    YaraProcedureRequest yaraProcedureRequest = (YaraProcedureRequest) o;
    return Objects.equals(this.procHashes, yaraProcedureRequest.procHashes) &&
        Objects.equals(this.name, yaraProcedureRequest.name) &&
        Objects.equals(this.condition, yaraProcedureRequest.condition) &&
        Objects.equals(this.includeAll, yaraProcedureRequest.includeAll) &&
        Objects.equals(this.maxSignatures, yaraProcedureRequest.maxSignatures);
  }

  @Override
  public int hashCode() {
    return Objects.hash(procHashes, name, condition, includeAll, maxSignatures);
  }
  ...
  public String toString() {
    ...
    sb.append("class YaraProcedureRequest {\n");
