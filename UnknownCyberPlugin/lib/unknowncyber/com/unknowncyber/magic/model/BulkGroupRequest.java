...
public class BulkGroupRequest implements Serializable{
  private static final long serialVersionUID = 1L;
  @JsonProperty("ids")
  private List<String> ids = new ArrayList<String>();

  public BulkGroupRequest ids(List<String> ids) {
    this.ids = ids;
    return this;
  }

  public BulkGroupRequest addIdsItem(String idsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BulkGroupRequest bulkGroupRequest = (BulkGroupRequest) o;
    return Objects.equals(this.ids, bulkGroupRequest.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class BulkGroupRequest {\n");
