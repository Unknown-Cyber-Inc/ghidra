...
import com.unknowncyber.magic.model.FileLabels;
...
public class EnvelopedFileLabelsList200 implements Serializable{
  ...
  private List<FileLabels> resources = new ArrayList<FileLabels>();

  public EnvelopedFileLabelsList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedFileLabelsList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedFileLabelsList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedFileLabelsList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedFileLabelsList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedFileLabelsList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedFileLabelsList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedFileLabelsList200 resources(List<FileLabels> resources) {
    this.resources = resources;
    return this;
  }

  public EnvelopedFileLabelsList200 addResourcesItem(FileLabels resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<FileLabels> getResources() {
    return resources;
  }

  public void setResources(List<FileLabels> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedFileLabelsList200 envelopedFileLabelsList200 = (EnvelopedFileLabelsList200) o;
    return Objects.equals(this.success, envelopedFileLabelsList200.success) &&
        Objects.equals(this.status, envelopedFileLabelsList200.status) &&
        Objects.equals(this.message, envelopedFileLabelsList200.message) &&
        Objects.equals(this.errors, envelopedFileLabelsList200.errors) &&
        Objects.equals(this.links, envelopedFileLabelsList200.links) &&
        Objects.equals(this.resources, envelopedFileLabelsList200.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedFileLabelsList200 {\n");
