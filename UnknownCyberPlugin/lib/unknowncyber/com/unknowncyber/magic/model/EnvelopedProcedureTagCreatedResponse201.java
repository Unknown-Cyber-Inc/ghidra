...
/**
 * EnvelopedProcedureTagCreatedResponse201
 */


public class EnvelopedProcedureTagCreatedResponse201 implements Serializable{
  ...
  private String message = "Resource Created";
  ...
  private ProcedureTagCreatedResponse resource = null;

  public EnvelopedProcedureTagCreatedResponse201 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedProcedureTagCreatedResponse201 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedProcedureTagCreatedResponse201 message(String message) {
  ...
  **/
  ...
  public EnvelopedProcedureTagCreatedResponse201 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedProcedureTagCreatedResponse201 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedProcedureTagCreatedResponse201 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedProcedureTagCreatedResponse201 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedProcedureTagCreatedResponse201 resource(ProcedureTagCreatedResponse resource) {
  ...
  **/
  @Schema(required = true, description = "")
  public ProcedureTagCreatedResponse getResource() {
    return resource;
  }

  public void setResource(ProcedureTagCreatedResponse resource) {
    this.resource = resource;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedProcedureTagCreatedResponse201 envelopedProcedureTagCreatedResponse201 = (EnvelopedProcedureTagCreatedResponse201) o;
    return Objects.equals(this.success, envelopedProcedureTagCreatedResponse201.success) &&
        Objects.equals(this.status, envelopedProcedureTagCreatedResponse201.status) &&
        Objects.equals(this.message, envelopedProcedureTagCreatedResponse201.message) &&
        Objects.equals(this.errors, envelopedProcedureTagCreatedResponse201.errors) &&
        Objects.equals(this.links, envelopedProcedureTagCreatedResponse201.links) &&
        Objects.equals(this.resource, envelopedProcedureTagCreatedResponse201.resource);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedProcedureTagCreatedResponse201 {\n");
