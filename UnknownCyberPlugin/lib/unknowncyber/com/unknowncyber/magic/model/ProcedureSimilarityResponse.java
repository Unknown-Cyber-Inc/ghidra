...
import com.unknowncyber.magic.model.ProcedureSimilarityItem;
...
public class ProcedureSimilarityResponse implements Serializable{
  private static final long serialVersionUID = 1L;
  @JsonProperty("proc_hash")
  private String procHash = "ecb50f092ebeeac4cf7804f8273d90e1";

  @JsonProperty("similarity_method")
  private String similarityMethod = "semantic_hash";

  @JsonProperty("procedures")
  private List<ProcedureSimilarityItem> procedures = null;

  public ProcedureSimilarityResponse procHash(String procHash) {
  ...
  **/
  ...
  public ProcedureSimilarityResponse similarityMethod(String similarityMethod) {
  ...
  **/
  ...
  public ProcedureSimilarityResponse procedures(List<ProcedureSimilarityItem> procedures) {
    this.procedures = procedures;
    return this;
  }

  public ProcedureSimilarityResponse addProceduresItem(ProcedureSimilarityItem proceduresItem) {
    if (this.procedures == null) {
      this.procedures = new ArrayList<ProcedureSimilarityItem>();
    }
  ...
  **/
  @Schema(description = "")
  public List<ProcedureSimilarityItem> getProcedures() {
    return procedures;
  }

  public void setProcedures(List<ProcedureSimilarityItem> procedures) {
    this.procedures = procedures;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.procHash, procedureSimilarityResponse.procHash) &&
        Objects.equals(this.similarityMethod, procedureSimilarityResponse.similarityMethod) &&
        Objects.equals(this.procedures, procedureSimilarityResponse.procedures);
  }

  @Override
  public int hashCode() {
    return Objects.hash(procHash, similarityMethod, procedures);
  }
  ...
  public String toString() {
    ...
    sb.append("    similarityMethod: ").append(toIndentedString(similarityMethod)).append("\n");
