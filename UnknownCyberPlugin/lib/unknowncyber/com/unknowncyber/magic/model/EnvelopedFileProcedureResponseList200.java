...
import com.unknowncyber.magic.model.FileProcedureResponse;
...
public class EnvelopedFileProcedureResponseList200 implements Serializable{
  ...
  private List<FileProcedureResponse> resources = new ArrayList<FileProcedureResponse>();

  public EnvelopedFileProcedureResponseList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedFileProcedureResponseList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedFileProcedureResponseList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedFileProcedureResponseList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedFileProcedureResponseList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedFileProcedureResponseList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedFileProcedureResponseList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedFileProcedureResponseList200 resources(List<FileProcedureResponse> resources) {
    this.resources = resources;
    return this;
  }

  public EnvelopedFileProcedureResponseList200 addResourcesItem(FileProcedureResponse resourcesItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<FileProcedureResponse> getResources() {
    return resources;
  }

  public void setResources(List<FileProcedureResponse> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedFileProcedureResponseList200 envelopedFileProcedureResponseList200 = (EnvelopedFileProcedureResponseList200) o;
    return Objects.equals(this.success, envelopedFileProcedureResponseList200.success) &&
        Objects.equals(this.status, envelopedFileProcedureResponseList200.status) &&
        Objects.equals(this.message, envelopedFileProcedureResponseList200.message) &&
        Objects.equals(this.errors, envelopedFileProcedureResponseList200.errors) &&
        Objects.equals(this.links, envelopedFileProcedureResponseList200.links) &&
        Objects.equals(this.resources, envelopedFileProcedureResponseList200.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedFileProcedureResponseList200 {\n");
