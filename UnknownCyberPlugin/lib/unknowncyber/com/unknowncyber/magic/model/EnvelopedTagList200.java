...
public class EnvelopedTagList200 implements Serializable, EnvelopedTagList200EnvelopedIdList200 {
  ...
  private List<Tag> resources = new ArrayList<Tag>();

  public EnvelopedTagList200 success(Boolean success) {
  ...
  **/
  ...
  public EnvelopedTagList200 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnvelopedTagList200 message(String message) {
  ...
  **/
  ...
  public EnvelopedTagList200 errors(List<ErrorObject> errors) {
    this.errors = errors;
    return this;
  }

  public EnvelopedTagList200 addErrorsItem(ErrorObject errorsItem) {
  ...
  **/
  ...
  public EnvelopedTagList200 links(Map<String, String> links) {
    this.links = links;
    return this;
  }

  public EnvelopedTagList200 putLinksItem(String key, String linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public EnvelopedTagList200 resources(List<Tag> resources) {
    this.resources = resources;
    return this;
  }

  public EnvelopedTagList200 addResourcesItem(Tag resourcesItem) {
  ...
  **/
  ...
  public void setResources(List<Tag> resources) {
    this.resources = resources;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnvelopedTagList200 envelopedTagList200 = (EnvelopedTagList200) o;
    return Objects.equals(this.success, envelopedTagList200.success) &&
        Objects.equals(this.status, envelopedTagList200.status) &&
        Objects.equals(this.message, envelopedTagList200.message) &&
        Objects.equals(this.errors, envelopedTagList200.errors) &&
        Objects.equals(this.links, envelopedTagList200.links) &&
        Objects.equals(this.resources, envelopedTagList200.resources);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvelopedTagList200 {\n");
