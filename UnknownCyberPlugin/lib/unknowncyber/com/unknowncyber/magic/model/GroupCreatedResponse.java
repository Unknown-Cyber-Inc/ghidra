...
public class GroupCreatedResponse implements Serializable{
  private static final long serialVersionUID = 1L;
  @JsonProperty("id")
  private String id = "644052109882106b133d6c7e";

  @JsonProperty("name")
  private String name = "my group";

  @JsonProperty("_self")
  private String _self = "https://api.magic.unknowncyber.com/v2/groups/644052109882106b133d6c7e";

  public GroupCreatedResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public GroupCreatedResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public GroupCreatedResponse _self(String _self) {
    this._self = _self;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupCreatedResponse groupCreatedResponse = (GroupCreatedResponse) o;
    return Objects.equals(this.id, groupCreatedResponse.id) &&
        Objects.equals(this.name, groupCreatedResponse.name) &&
        Objects.equals(this._self, groupCreatedResponse._self);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, _self);
  }
