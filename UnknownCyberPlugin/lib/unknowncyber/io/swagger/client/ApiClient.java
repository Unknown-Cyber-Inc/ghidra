...
public class ApiClient {
  ...
  public ApiClient() {
    ...
    authentications.put("Api Key Header Authentication", headerAuth);
    ApiKeyAuth keyAuth = new ApiKeyAuth("query", "key");
    keyAuth.setApiKey(key);
    authentications.put("Api Key Query Authentication", keyAuth);
    authentications.put("Basic Authentication", new HttpBasicAuth());
    authentications.put("JWT Access Token Authentication", new OAuth());
